function [output] = makepulseoutputs(start_time, pulsenumber, pulseduration, pulseamp ,pulsefrequency, Fs, sweepduration, pulseampDelta)
...
pulsedurationDelta = pulseampDelta;
